...
public class DetailProdukKeranjangActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = getIntent().getStringExtra(Keranjang.TAG_PRODUK);
        ...
        if (sessionManager.isLoggedIn()){
                ...
                public void onResponse(Call<ProdukDetailResponse> call, Response<ProdukDetailResponse> response) {
                    if (response.isSuccessful()){
                        if (response.body().getMaster().size()>0){
                            ...
                            Picasso.with(DetailProdukKeranjangActivity.this)
            ...
            fab_beli.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(DetailProdukKeranjangActivity.this, DetailKonfirmasiProdukActivity.class);
...
//                                    Toast.makeText(getApplicationContext(), "id kosong", Toast.LENGTH_LONG).show();
        ...
        iv_foto_produk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(DetailProdukKeranjangActivity.this);
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("login", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(DetailProdukKeranjangActivity.this,LoginActivity.class);
                        finish();
                        startActivity(intent);
                    }
                })
...
////                return true;
    ...
    private void goToMainActivity(){
        Intent intent = new Intent(DetailProdukKeranjangActivity.this, MainActivity.class);
