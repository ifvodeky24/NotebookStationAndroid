...
public class SedangDikirimActivity extends AppCompatActivity {
    ...
    private void getData() {
        ...
        apiInterface.sedangDikirim(id_konsumen).enqueue(new Callback<SedangDikirimResponse>() {
            @Override
...
//                        Toast.makeText(getApplicationContext(), "Data Menunggu Pembayaran Kosong", Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onFailure(Call<SedangDikirimResponse> call, Throwable t) {
